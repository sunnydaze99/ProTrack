...
<body>
    <div class="registration-container">
        <form action="" method="post">
            ...
            <input type="text" id="professorName" name="name" required placeholder="enter your name">

            <label for="professorEmail">Email:</label>
            <input type="email" id="professorEmail" name="email" required placeholder="enter your email">

            <label for="professorPassword">Password:</label>
            <input type="password" id="professorPassword" name="password" required placeholder="enter your password">

            <label for="professorCPassword">Confirm Password:</label>
